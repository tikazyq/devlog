export class EnterpriseSync {
    ...
    async createOrUpdateJiraIssue(entry, config) {
    ...
    async createOrUpdateADOWorkItem(entry, config) {
    ...
    async createOrUpdateGitHubIssue(entry, config) {
        const issueData = {
            title: entry.title,
    ...
    formatDescriptionForJira(entry) {
    ...
    formatDescriptionForGitHub(entry) {
        let description = entry.description;
        if (entry.context.businessContext) {
    ...
    mapDevlogTypeToJiraIssueType(type) {
        const mapping = {
            feature: "Story",
            bugfix: "Bug",
            task: "Task",
    ...
    mapDevlogTypeToADOWorkItemType(type) {
        const mapping = {
            feature: "User Story",
            bugfix: "Bug",
            task: "Task",
    ...
    mapDevlogPriorityToJiraPriority(priority) {
        const mapping = {
            low: "Low",
            medium: "Medium",
            high: "High",
    ...
    mapDevlogPriorityToADOPriority(priority) {
        const mapping = {
            low: 4,
            medium: 3,
            high: 2,
